            ...
            div(class = "purpose",
              ...
              tags$ul(
                ...
                tags$li(strong("Age-dependent selection is widely overlooked. "),
                        "Lifespan, or age at first record, can be linked to how fast or in what shape individuals age, not only to their average age-independent phenotype."),
      ...
      tabItem(tabName = "data",
        ...
        fluidRow(
          ...
          box(width = 8, title = info_title("Map columns", "mapping"), status = "primary", solidHeader = TRUE,
            uiOutput("mapping_ui"),
            box_note(strong("AFR"), " = age at first record. ",
        ...
        fluidRow(
          box(width = 12, title = "Glossary of terms", status = "info", solidHeader = FALSE,
              ...
              tags$ul(class = "small-note",
                ...
                tags$li(strong("AFR"), " \u2014 age at first record."),
